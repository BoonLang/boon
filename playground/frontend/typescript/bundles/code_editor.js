...
const parser = parser$1.configure({ props: [styleTags({
	...
	Pipe: tags.operator,
	Arrow: tags.operator,
	NotEqual: tags.operator,
	GreaterOrEqual: tags.operator,
	LessOrEqual: tags.operator,
	Greater: tags.operator,
	Less: tags.operator,
	Equal: tags.operator,
	Plus: tags.operator,
	Minus: tags.operator,
...
const oneDarkTheme = EditorView.theme({
	...
	".cm-content span.cm-boon-chain-alt": { color: "#bbbbbb !important" },
	".cm-content span.cm-boon-chain-alt > span": { color: "#bbbbbb !important" },
	...
	".cm-scroller::-webkit-scrollbar-track": { background: "rgba(255, 255, 255, 0.02)" },
	...
	".cm-scroller::-webkit-scrollbar-thumb:hover": { backgroundColor: "rgba(59, 109, 172, 0.85)" },
