...
const parser = baseParser.configure({
  props: [
    styleTags({
      ...
      ModulePathLiteral: t.namespace,
      ModulePathTail: t.namespace,
      ModulePathStart: t.namespace,
      'ModulePathLiteral/ModulePathStart/PascalCaseIdentifier': t.namespace,
      'ModulePathTail/ModulePathStart/PascalCaseIdentifier': t.namespace,
      'ModulePathTail/SnakeCaseIdentifier': t.namespace,
      'ModulePathLiteral/ModulePathStart/Slash': t.separator,
      'ModulePathTail/ModulePathStart/Slash': t.separator,
