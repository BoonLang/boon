...
pub struct EventLoop {
    ...
    pending_ticks: AtomicU32,     // Count of deferred ticks
    // ...
}
...
impl EventLoop {
    ...
    fn schedule_tick(&self) {
        ...
        // CLI: If already in a tick, defer (don't run nested)
...
- When `in_tick` is true, `schedule_tick()` increments `pending_ticks` instead of running
