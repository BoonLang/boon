...
These are design questions identified during analysis. This file serves as a **consolidated decision log** - showing what was considered and why. Implementation details are embedded in the relevant main docs (e.g., FLUSH isolation in §2.6, FIFO ordering in §2.4, determinism in §2.0).
