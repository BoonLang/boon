...
## 5.2.2 Target Architecture: RV32I
...
## 5.2.4 Module Breakdown

### 5.2.4.1 Top-Level Modules
...
### 5.2.4.2 Instruction Fetch Stage
...
### 5.2.4.3 Instruction Decode Stage
...
## 5.2.6 Boon Language Features Used
