...
- Note: `requestAnimationFrame` is NOT used for reactive scheduling (see §2.4.12)
...
**Files to modify:**
- `crates/boon/src/engine_v2/event_loop.rs` - Multi-domain support
- `crates/boon/src/platform/browser/worker_runtime.rs` - WebWorker integration (future)
