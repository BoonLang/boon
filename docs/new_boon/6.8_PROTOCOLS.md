...
{
  "_type": "list_delta",
  "operation": "insert" | "update" | "field_update" | "remove" | "move" | "replace",
  "key": "item_key_abc",           // ItemKey for item identity (all except replace)
  "index": 2,                       // Position (for insert/move)
  "value": { ... },                 // Payload (for insert/update/field_update)
  "field": "status",                // FieldId (for field_update only)
  "from_index": 1,                  // For move operations
  "to_index": 3,
  "items": [...]                    // For replace: full list contents
}
```
