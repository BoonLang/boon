...
| File | Purpose |
|------|---------|
| `crates/boon/src/engine/diagnostics/mod.rs` | **NEW:** Public API |
| `crates/boon/src/engine/diagnostics/hooks.rs` | **NEW:** DiagnosticsHooks trait |
| `crates/boon/src/engine/diagnostics/snapshot.rs` | **NEW:** Full graph export |
| `crates/boon/src/engine/diagnostics/delta.rs` | **NEW:** Streaming deltas |
| `crates/boon/src/engine/diagnostics/transport.rs` | **NEW:** Transport abstraction |
