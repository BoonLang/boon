...
```
Document/new : (root: Element | Text | Number) -> Document
```
...
Element/checkbox   : (element: Unit | Element, style: Unit | Style, checked: Bool) -> Element
...
Element/stripe     : (element: Unit | Element, style: Unit | Style, items: List<Element>, direction: Horizontal | Vertical, gap: Number) -> Element
Element/text_input : (element: Unit | Element, style: Unit | Style, text: Text, placeholder: Text) -> Element
```
...
Oklch[l: Number, c: Number, h: Number]  // Color in Oklch color space
Oklch[l: Number, c: Number, h: Number, a: Number]  // With alpha
