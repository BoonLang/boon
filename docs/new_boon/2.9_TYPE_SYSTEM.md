...
**Runtime representation:** Duration normalizes to milliseconds internally. The tagged object syntax is parsed at compile time and converted to `Payload::Number(ms)` for the timer queue.
