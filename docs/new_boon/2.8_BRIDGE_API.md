...
impl Bridge {
    ...
    pub fn render(&mut self) {
        ...
        let root_element = self.arena.navigate_field(doc_slot, "root");
...
| **Bits** | `Bits/not`, `Bits/or`, `Bits/and` | 3 |

**Tagged Objects (4 total):**

| Tag | Shape | Usage |
|-----|-------|-------|
| `Duration` | `Duration[milliseconds: Number]` | Timer intervals |
| `Oklch` | `Oklch[lightness:, chroma:, hue:, alpha:]` | Color styling |
| `Hidden` | `Hidden[element: Element]` | Element visibility |
