...
pub enum SemanticTextPart {
    ...
    DerivedScalarExpr(DerivedScalarOperand),
...
pub enum SemanticInputValue {
    ...
    Node(Box<SemanticNode>),
    ParsedTextBindingBranch {
        binding: String,
        number: Box<SemanticInputValue>,
        nan: Box<SemanticInputValue>,
    },
    TextValueBranch {
        binding: String,
        expected: String,
...
pub enum ObjectListFilter {
    ...
    TextFieldStartsWithTextBinding { field: String, binding: String },
    ItemIdEqualsScalarBinding { binding: String },
}
...
pub enum ObjectItemActionKind {
    ...
    UpdateBindings {
        ...
        object_list_updates: Vec<ObjectListUpdate>,
        payload_filter: Option<String>,
    },
    RemoveSelf,
}
...
pub enum DerivedScalarOperand {
    ...
    Arithmetic {
        ...
        left: Box<DerivedScalarOperand>,
        right: Box<DerivedScalarOperand>,
    },
    Min {
        left: Box<DerivedScalarOperand>,
        right: Box<DerivedScalarOperand>,
    ...
    Round {
        source: Box<DerivedScalarOperand>,
    },
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum DerivedTextOperand {
    Binding(String),
    Literal(String),
}
...
pub enum DerivedScalarSpec {
    ...
    TextComparison {
        target: String,
        op: IntCompareOp,
        left: DerivedTextOperand,
        right: DerivedTextOperand,
    },
}
...
pub struct StateRuntimeModel {
    ...
    pub scalar_mirrors: BTreeMap<String, Vec<String>>,
    pub text_mirrors: BTreeMap<String, Vec<String>>,
...
pub enum TextUpdate {
    ...
    SetComputedBranch {
        ...
        truthy_parts: Vec<SemanticTextPart>,
        falsy_parts: Vec<SemanticTextPart>,
        payload_filter: Option<String>,
    },
    SetFromInput {
        binding: String,
...
pub enum ObjectListUpdate {
    ...
    AppendBoundObject {
        binding: String,
        scalar_bindings: BTreeMap<String, String>,
        text_bindings: BTreeMap<String, String>,
        payload_filter: Option<String>,
    },
    AppendPayloadObject {
        binding: String,
        scalar_payload_fields: BTreeMap<String, String>,
    },
    AppendDraftObject {
        binding: String,
        source_binding: String,
